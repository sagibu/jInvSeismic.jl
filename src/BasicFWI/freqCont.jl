...
function freqCont(mc, pFor, Dobs::Array, Wd::Array, pInv::InverseParam, misfun::Function,
...
function freqCont(mc, pInv::InverseParam, pMis::MisfitParam,nfreq::Int64, windowSize::Int64,
