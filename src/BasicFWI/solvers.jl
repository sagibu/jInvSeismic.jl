...
export solveForwardProblemOrig
function solveForwardProblemOrig(m::Array{Float64, 2}, pForp::Array{RemoteChannel}, omega::Vector, nrec::Int64,
	nsrc::Int64, nfreq::Int64)
...
export solveInverseProblemOrig
function solveInverseProblemOrig(pFor::Array{RemoteChannel}, Dobs::Array, Wd::Array,
	nfreq::Int64, nx::Int64, nz::Int64, mref::Array{Float64,2}, Mr::RegularMesh,
	boundsHigh::Float64, boundsLow::Float64, resultsFilename::String, plotting::Bool=false,
	plottingFunc::Function=dummy)
	println("Inveroriginal");
	# mref = 3.0*ones(nx,nz);
	# mref = 1.0./(mref.^2); # convert to slowness squared
	N = prod(Mr.n);
	Iact = sparse(I,N,N);
